...
THEIA_DECLARE_REMOTE_CODEC(system_apps_DemoFsmData)
THEIA_DECLARE_REMOTE_CODEC(system_apps_DemoStart)
THEIA_DECLARE_REMOTE_CODEC(system_apps_DemoFinish)
THEIA_DECLARE_REMOTE_CODEC(system_apps_DemoReset)
