...
THEIA_DECLARE_REMOTE_CODEC(system_demo_DemoFsmData)
THEIA_DECLARE_REMOTE_CODEC(system_demo_DemoStart)
THEIA_DECLARE_REMOTE_CODEC(system_demo_DemoFinish)
THEIA_DECLARE_REMOTE_CODEC(system_demo_DemoReset)
