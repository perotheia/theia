...
#include "apps/v2v_app/v2v_app.pb.h"

#include "packages/v2v/v2v.pb.h"



THEIA_DECLARE_REMOTE_CODEC(packages_v2v_Beacon)
THEIA_DECLARE_REMOTE_CODEC(packages_v2v_GetConstellationReq)
THEIA_DECLARE_REMOTE_CODEC(packages_v2v_ConstellationUpdate)
THEIA_DECLARE_REMOTE_CODEC(packages_v2v_GetAlertDecisionReq)
THEIA_DECLARE_REMOTE_CODEC(packages_v2v_AlertDecision)
THEIA_DECLARE_REMOTE_CODEC(packages_v2v_InjectBeaconReq)
THEIA_DECLARE_REMOTE_CODEC(packages_v2v_InjectBeaconReply)
