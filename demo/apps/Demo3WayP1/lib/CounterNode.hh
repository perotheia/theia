...
public:
    ...
    // ---- config update — body in impl (CounterNode_handlers.cc) -------
    //
    // This node binds `config CounterConfig`. services/per casts a
    ...
    // ParseFromString cfg.config into CounterConfig and honor the changed mask.
