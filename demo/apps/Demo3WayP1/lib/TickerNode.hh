...
#include "impl/TickerNode_state.hh"
...
class TickerNode : public ::theia::runtime::GenServer<TickerNode, TickerNodeState> {
public:
    static constexpr const char* kNodeName = "ticker";
    static constexpr uint32_t kTipcType     = 0xd0010003u;
    ...
    using ::theia::runtime::GenServer<TickerNode, TickerNodeState>::handle_cast;
    ...
    // (post_info / self-tick).
    void terminate(const char* /*reason*/, TickerNodeState& /*s*/) noexcept {}
    ...
    // ---- OTP init/1 — body in impl (TickerNode_handlers.cc) ----------
    //
    ...
    void handle_info(const char* info, TickerNodeState& s);
