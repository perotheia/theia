...
#include "impl/ObserverNode_state.hh"
...
class ObserverNode : public ::theia::runtime::GenServer<ObserverNode, ObserverNodeState> {
public:
    static constexpr const char* kNodeName = "observer";
    static constexpr uint32_t kTipcType     = 0xd0010004u;
    ...
    using ::theia::runtime::GenServer<ObserverNode, ObserverNodeState>::handle_cast;
    ...
    // (post_info / self-tick).
    void terminate(const char* /*reason*/, ObserverNodeState& /*s*/) noexcept {}
    ...
    // ---- OTP init/1 — body in impl (ObserverNode_handlers.cc) ----------
    //
    ...
    void handle_info(const char* info, ObserverNodeState& s);

    // ---- config update — body in impl (ObserverNode_handlers.cc) -------
    //
    // This node binds `config ObserverConfig`. services/per casts a
    ...
    // ParseFromString cfg.config into ObserverConfig and honor the changed mask.
