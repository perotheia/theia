...
``manifest/zonal_rig.py`` — which carries the SAME 2-machine shape but
...
third rig: ``manifest/rig.py`` (drives ``theia install`` → install/).
...
# ---------------------------------------------------------------------------
#
# `manifest/applications.py` is GENERATED from `cluster Applications`
...
from manifest.applications import (  # noqa: E402
...
# manifest.rig --rig CentralRig` (and ComputeRig) consume to write
