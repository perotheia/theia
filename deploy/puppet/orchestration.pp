...
# /etc/theia/manifest/application.yaml and reinstalls the .ipks
# under /opt/theia/apps/.
#
# WHEN TO USE: day-to-day application pushes. Does NOT touch the
# supervisor / gateway / etcd / schema. Safe to run on a live
# system without service downtime — the supervisor reloads its
# child table after the .ipk swap.
#
