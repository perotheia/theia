...
| [`bazel-build/`](bazel-build/) | Bazel build workflows (host, firmware, packaging). |
| [`google-repo-tools/`](google-repo-tools/) | Google `repo` workspace operations (sync, manifests, local manifests). |
