...
PROCESS_PARAMS = {   'com': {   'nodes': {'com_grpc_proxy': {'grpc_listen': '0.0.0.0:7700'}},
    ...
    'log': {   'aliases': {   'log_pump': 'log_stream_pump',
                              'trace_pump': 'trace_stream_pump'},
               'nodes': {},
    ...
    'per': {   'const': {'per_client': ['etcd_endpoint']},
               'nodes': {   'per_client': {   'etcd_endpoint': '127.0.0.1:2379',
                                              'push_connect_ms': 250},
                            'per_manager': {'snapshot_dir': '/opt/theia/dbbackup'}},
    ...
    'tsync': {   'aliases': {'phc2sys': 'phc2sys_provider', 'ptp4l': 'ptp4l_provider'},
                 'nodes': {   'phc2sys': {'args': '-a -r -m -q', 'enabled': True},
