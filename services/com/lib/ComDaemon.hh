...
// ara::com`) so it isn't nested under this file's
// namespace block — bound as the GenServer State type below.
#include "impl/ComDaemon_state.hh"
...
using NetworkBindingRequest = system_services_com_NetworkBindingRequest;
...
class ComDaemon : public ::theia::runtime::GenServer<ComDaemon, ComDaemonState> {
public:
    ...
    using ::theia::runtime::GenServer<ComDaemon, ComDaemonState>::handle_cast;
    ...
    // ---- OTP init/1 — body in impl (ComDaemon_handlers.cc) ----------
    //
