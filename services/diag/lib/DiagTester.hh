...
class DiagTester : public ::theia::runtime::GenServer<DiagTester, DiagTesterState> {
public:
    static constexpr const char* kNodeName = "diag_tester";
    static constexpr uint32_t kTipcType     = 0x80010019u;
    ...
    using ::theia::runtime::GenServer<DiagTester, DiagTesterState>::handle_cast;
    ...
    // (post_info / self-tick).
    void terminate(const char* /*reason*/, DiagTesterState& /*s*/) noexcept {}
    ...
    // ---- OTP init/1 — body in impl (DiagTester_handlers.cc) ----------
    //
    ...
    void handle_info(const char* info, DiagTesterState& s);
