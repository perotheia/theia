...
#include "diag_codecs.hh"   // FC-wide inbound RemoteCodecs (#387)
...
#include "impl/UdsRouter_state.hh"
...
// (system_services_diag_*); aliasing them here keeps callers'
// signatures readable.
...
class UdsRouter : public ::theia::runtime::GenServer<UdsRouter, UdsRouterState> {
public:
    static constexpr const char* kNodeName = "uds_router";
    static constexpr uint32_t kTipcType     = 0x80010018u;
    ...
    using ::theia::runtime::GenServer<UdsRouter, UdsRouterState>::handle_cast;
    ...
    // (post_info / self-tick).
    void terminate(const char* /*reason*/, UdsRouterState& /*s*/) noexcept {}
    ...
    // ---- OTP init/1 — body in impl (UdsRouter_handlers.cc) ----------
    //
    ...
    void handle_info(const char* info, UdsRouterState& s);

    // ---- config update — body in impl (UdsRouter_handlers.cc) -------
    //
    // This node binds `config DiagConfig`. services/per casts a
    ...
    // ParseFromString cfg.config into DiagConfig and honor the changed mask.
