...
#include "impl/PerDaemon_state.hh"
...
// signatures readable.
using PerKey = system_services_per_PerKey;
using PerValue = system_services_per_PerValue;
using PerPut = system_services_per_PerPut;
using PerEmpty = system_services_per_PerEmpty;
...
class PerDaemon : public ::theia::runtime::GenServer<PerDaemon, PerDaemonState> {
public:
    ...
    using ::theia::runtime::GenServer<PerDaemon, PerDaemonState>::handle_cast;
    ...
    // ---- OTP init/1 — body in impl (PerDaemon_handlers.cc) ----------
    //
