...
// derives from FgGateStateMBase (gen_statem-shaped); without
...
class FgGate : public ::theia::runtime::GenServer<FgGate, FgGateState> {
public:
    static constexpr const char* kNodeName = "fg_gate";
    static constexpr uint32_t kTipcType     = 0x8001004Du;
    ...
    using ::theia::runtime::GenServer<FgGate, FgGateState>::handle_cast;
    ...
    // (post_info / self-tick).
    void terminate(const char* /*reason*/, FgGateState& /*s*/) noexcept {}
    ...
    void handle_cast(const FgStart& msg, FgGateState& s);

    void handle_cast(const FgStarted& msg, FgGateState& s);

    void handle_cast(const FgStop& msg, FgGateState& s);

    void handle_cast(const FgStopped& msg, FgGateState& s);

    void handle_cast(const FgDegraded& msg, FgGateState& s);
    ...
    // ---- OTP init/1 — body in impl (FgGate_handlers.cc) ----------
    //
    ...
    void handle_info(const char* info, FgGateState& s);
