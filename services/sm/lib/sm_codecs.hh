...
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_SystemBoot)
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_StartupComplete)
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_ShutdownRequest)
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_UpdateRequest)
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_UpdateComplete)
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_RetryStartup)
DEMO_DECLARE_REMOTE_CODEC(services_services_sm_PowerOff)
